...
$first = $_POST['first'];
$last = $_POST['last'];
$query = "SELECT master.nameFirst, master.nameLast, CollegePlaying.yearID, Schools.name_full, Schools.city, Schools.state
FROM master
JOIN CollegePlaying
ON master.playerID = CollegePlaying.playerID
JOIN Schools
ON Schools.schoolID = CollegePlaying.schoolID
WHERE master.nameFirst = '$first'
AND master.nameLast = '$last'";
        ...
        <div class="row">
          <div class="col-lg-8 col-lg-offset-2">
            ...
            if($response){
                ...
                <td align="left"><b>&emsp;&emsp;School</b></td>
                ...
                while($row = mysqli_fetch_array($response)){
                    ...
                    $row['yearID'] . '</td><td align="left">' . '&emsp;&emsp;' .
                    $row['name_full'] . '</td><td align="left">' . '&emsp;&emsp;' .
